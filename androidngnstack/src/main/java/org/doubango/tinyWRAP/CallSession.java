...
public class CallSession extends InviteSession {
  ...
  public boolean transfer(String referToUriString, CallSession destSession, ActionConfig config) {
    return tinyWRAPJNI.CallSession_transfer__SWIG_0(swigCPtr, this, referToUriString, CallSession.getCPtr(destSession), destSession, ActionConfig.getCPtr(config), config);
  }

  public boolean transfer(String referToUriString, CallSession destSession) {
    return tinyWRAPJNI.CallSession_transfer__SWIG_1(swigCPtr, this, referToUriString, CallSession.getCPtr(destSession), destSession);
  }

  public boolean transfer(String referToUriString) {
    return tinyWRAPJNI.CallSession_transfer__SWIG_2(swigCPtr, this, referToUriString);
  }

  public boolean sendTransfer(String referToDisplayName, String referToPhoneNum, ActionConfig config) {
    return tinyWRAPJNI.CallSession_sendTransfer__SWIG_0(swigCPtr, this, referToDisplayName, referToPhoneNum, ActionConfig.getCPtr(config), config);
  }

  public boolean sendTransfer(String referToDisplayName, String referToPhoneNum) {
    return tinyWRAPJNI.CallSession_sendTransfer__SWIG_1(swigCPtr, this, referToDisplayName, referToPhoneNum);
  }
