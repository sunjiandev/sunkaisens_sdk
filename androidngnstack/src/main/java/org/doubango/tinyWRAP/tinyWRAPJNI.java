...
public class tinyWRAPJNI {
  ...
  public final static native boolean MediaSessionMgr_defaultsSetNetworkBearPacketsLose(int jarg1);
  ...
  public final static native boolean MediaSessionMgr_defaultsSetVideoFecEnabled(boolean jarg1);
  public final static native boolean MediaSessionMgr_defaultsGetVideoFecEnabled();
  ...
  public final static native boolean MediaSessionMgr_defaultsSetDSCP(int jarg1, int jarg2, int jarg3);
  public final static native boolean MediaSessionMgr_defaultsSetCheckNetworkEnabled(boolean jarg1);
  public final static native long new_MediaSessionMgr(String jarg1);
  public final static native boolean MediaSessionMgr_callAudio(long jarg1, MediaSessionMgr jarg1_, String jarg2);
  public final static native boolean MediaSessionMgr_callGroupAudio(long jarg1, MediaSessionMgr jarg1_, String jarg2);
  public final static native boolean MediaSessionMgr_callVideo(long jarg1, MediaSessionMgr jarg1_, String jarg2);
  public final static native boolean MediaSessionMgr_callGroupVideo(long jarg1, MediaSessionMgr jarg1_, String jarg2);
  public final static native boolean MediaSessionMgr_call(long jarg1, MediaSessionMgr jarg1_, String jarg2, int jarg3);
  public final static native boolean MediaSessionMgr_acceptGroupCall(long jarg1, MediaSessionMgr jarg1_, String jarg2, int jarg3, int jarg4, int jarg5);
  public final static native boolean MediaSessionMgr_startSession__SWIG_0(long jarg1, MediaSessionMgr jarg1_);
  public final static native boolean MediaSessionMgr_hungup(long jarg1, MediaSessionMgr jarg1_);
  public final static native boolean MediaSessionMgr_acceptCall(long jarg1, MediaSessionMgr jarg1_, String jarg2, int jarg3, int jarg4, int jarg5);
  public final static native boolean MediaSessionMgr_startSession__SWIG_1(long jarg1, MediaSessionMgr jarg1_, String jarg2, int jarg3, int jarg4);
  public final static native boolean MediaSessionMgr_getRemoteIPnPort(long jarg1, MediaSessionMgr jarg1_, String jarg2, int[] jarg3, int[] jarg4);
  public final static native int MediaSessionMgr_getAudioPort(long jarg1, MediaSessionMgr jarg1_, int[] jarg2);
  public final static native int MediaSessionMgr_getVideoPort(long jarg1, MediaSessionMgr jarg1_, int[] jarg2);
  public final static native boolean MediaSessionMgr_setRemoteIPnPort(long jarg1, MediaSessionMgr jarg1_, String jarg2, int jarg3, int jarg4);
  public final static native boolean MediaSessionMgr_setAudioPort(long jarg1, MediaSessionMgr jarg1_, int jarg2);
  public final static native boolean MediaSessionMgr_setVideoPort(long jarg1, MediaSessionMgr jarg1_, int jarg2);
  public final static native int MediaSessionMgr_getId(long jarg1, MediaSessionMgr jarg1_);
  ...
  public final static native boolean CallSession_transfer__SWIG_0(long jarg1, CallSession jarg1_, String jarg2, long jarg3, CallSession jarg3_, long jarg4, ActionConfig jarg4_);
  public final static native boolean CallSession_transfer__SWIG_1(long jarg1, CallSession jarg1_, String jarg2, long jarg3, CallSession jarg3_);
  public final static native boolean CallSession_transfer__SWIG_2(long jarg1, CallSession jarg1_, String jarg2);
  public final static native boolean CallSession_sendTransfer__SWIG_0(long jarg1, CallSession jarg1_, String jarg2, String jarg3, long jarg4, ActionConfig jarg4_);
  public final static native boolean CallSession_sendTransfer__SWIG_1(long jarg1, CallSession jarg1_, String jarg2, String jarg3);
  ...
  public final static native long initJNICrashHandl(String path);
  public final static native long destoryJNICrashHandl();
}
