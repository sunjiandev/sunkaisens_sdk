...
public class MediaSessionMgr {
  ...
  public static boolean defaultsSetNetworkBearPacketsLose(int packets_lose) {
    return tinyWRAPJNI.MediaSessionMgr_defaultsSetNetworkBearPacketsLose(packets_lose);
  }
  ...
  public static boolean defaultsSetVideoFecEnabled(boolean video_fec_enabled) {
    return tinyWRAPJNI.MediaSessionMgr_defaultsSetVideoFecEnabled(video_fec_enabled);
  }

  public static boolean defaultsGetVideoFecEnabled() {
    return tinyWRAPJNI.MediaSessionMgr_defaultsGetVideoFecEnabled();
  }
  ...
  public static boolean defaultsSetDSCP(int cmd, int mediaAudio, int mediaVideo) {
    return tinyWRAPJNI.MediaSessionMgr_defaultsSetDSCP(cmd, mediaAudio, mediaVideo);
  }

  public static boolean defaultsSetCheckNetworkEnabled(boolean check_enabled) {
    return tinyWRAPJNI.MediaSessionMgr_defaultsSetCheckNetworkEnabled(check_enabled);
  }

  public MediaSessionMgr(String _local_ip) {
    this(tinyWRAPJNI.new_MediaSessionMgr(_local_ip), true);
  }

  public boolean callAudio(String remoteUriString) {
    return tinyWRAPJNI.MediaSessionMgr_callAudio(swigCPtr, this, remoteUriString);
  }

  public boolean callGroupAudio(String remoteUriString) {
    return tinyWRAPJNI.MediaSessionMgr_callGroupAudio(swigCPtr, this, remoteUriString);
  }

  public boolean callVideo(String remoteUriString) {
    return tinyWRAPJNI.MediaSessionMgr_callVideo(swigCPtr, this, remoteUriString);
  }

  public boolean callGroupVideo(String remoteUriString) {
    return tinyWRAPJNI.MediaSessionMgr_callGroupVideo(swigCPtr, this, remoteUriString);
  }

  public boolean call(String remoteUriString, twrap_media_type_t media) {
    return tinyWRAPJNI.MediaSessionMgr_call(swigCPtr, this, remoteUriString, media.swigValue());
  }

  public boolean acceptGroupCall(String remoteUriString, twrap_media_type_t mediaType, int audioPort, int videoPort) {
    return tinyWRAPJNI.MediaSessionMgr_acceptGroupCall(swigCPtr, this, remoteUriString, mediaType.swigValue(), audioPort, videoPort);
  }

  public boolean startSession() {
    return tinyWRAPJNI.MediaSessionMgr_startSession__SWIG_0(swigCPtr, this);
  }

  public boolean hungup() {
    return tinyWRAPJNI.MediaSessionMgr_hungup(swigCPtr, this);
  }

  public boolean acceptCall(String remoteUriString, twrap_media_type_t mediaType, int audioPort, int videoPort) {
    return tinyWRAPJNI.MediaSessionMgr_acceptCall(swigCPtr, this, remoteUriString, mediaType.swigValue(), audioPort, videoPort);
  }

  public boolean startSession(String remoteIP, int audioPort, int videoPort) {
    return tinyWRAPJNI.MediaSessionMgr_startSession__SWIG_1(swigCPtr, this, remoteIP, audioPort, videoPort);
  }

  public boolean getRemoteIPnPort(String remoteIP, int[] arg1, int[] arg2) {
    return tinyWRAPJNI.MediaSessionMgr_getRemoteIPnPort(swigCPtr, this, remoteIP, arg1, arg2);
  }

  public int getAudioPort(int[] OUTPUT) {
    return tinyWRAPJNI.MediaSessionMgr_getAudioPort(swigCPtr, this, OUTPUT);
  }

  public int getVideoPort(int[] OUTPUT) {
    return tinyWRAPJNI.MediaSessionMgr_getVideoPort(swigCPtr, this, OUTPUT);
  }

  public boolean setRemoteIPnPort(String remoteIP, int audioPort, int videoPort) {
    return tinyWRAPJNI.MediaSessionMgr_setRemoteIPnPort(swigCPtr, this, remoteIP, audioPort, videoPort);
  }

  public boolean setAudioPort(int audio_port) {
    return tinyWRAPJNI.MediaSessionMgr_setAudioPort(swigCPtr, this, audio_port);
  }

  public boolean setVideoPort(int video_port) {
    return tinyWRAPJNI.MediaSessionMgr_setVideoPort(swigCPtr, this, video_port);
  }

  public int getId() {
    return tinyWRAPJNI.MediaSessionMgr_getId(swigCPtr, this);
  }
