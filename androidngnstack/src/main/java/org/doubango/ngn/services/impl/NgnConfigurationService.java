...
public class NgnConfigurationService extends NgnBaseService implements INgnConfigurationService {
	...
	public NgnConfigurationService(){
		final Context applicationContext = NgnSKDroid.getInstence().getGlobleContext();
		if(applicationContext != null){
			mSettings = NgnSKDroid.getInstence().getGlobleContext().getSharedPreferences(NgnConfigurationEntry.SHARED_PREF_NAME, 0);
