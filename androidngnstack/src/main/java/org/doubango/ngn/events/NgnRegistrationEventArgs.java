...
public class NgnRegistrationEventArgs extends NgnEventArgs {
	...
	public static final String ACTION_REFRESHREGISTRATION_EVENT = TAG + ".ACTION_REFRESHREGISTRATION_CHANGED";
	
	public static final String REFRESHREGISTRATION = TAG + ".REFRESHREGISTRATION";
