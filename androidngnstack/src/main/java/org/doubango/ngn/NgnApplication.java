...
public class NgnApplication extends Application{
    ...
    public static final String sBuildModel = Build.MODEL.toLowerCase();
    ...
    public static boolean isZTE(){
    	return sBuildModel.toLowerCase().startsWith("zte");
    }
    ...
    /**
     * Whether the stack is running on a Huawei device
     * @return true if the stack is running on a Huawei device and false otherwise
     */
    public static boolean isHuawei(){
    	return sBuildModel.toLowerCase().startsWith("huawei") ;
    }
    
    public static boolean isMI(){
    	return sBuildModel.toLowerCase().startsWith("mi") ;
    }
    
    public static boolean isZTE_grand(){
    	return sBuildModel.toLowerCase().startsWith("zte grand") ;
    }
	...
	public static boolean isBh() {
		return isBh03() || isBh04();
	}
    
	/**
	 * 手持台
	 */
	public static boolean isBh03() {
		return sBuildModel.startsWith("bh03");
	}
    
	/**
	 * 正样PAD
	 */
	public static boolean isBh04() {
		return sBuildModel.startsWith("bh04");
	}
	 ...
	 * @return
	 */
	public static boolean isBhSocket() {
		return sBuildModel.startsWith("sabresd");
	}
    
	/**
	 * 联芯大终端、联芯PAD
	 */
	public static boolean isl8848a_l1860() {
		//lc1810 l8848a(联芯大终端) l1860(联芯PAD)
		Log.d(TAG,"sBuildModel = "+sBuildModel);
		if (sBuildModel.startsWith("l8848")||sBuildModel.startsWith("l1860")) {
			return true;
		};
		return false;
	}
	 ...
	 * 瀚讯大终端
	 */
	public static boolean isHxSabresd() {
		Log.d(TAG, "isHxSabresd()");
		Log.d(TAG, "sBuildModel = " + sBuildModel); //sabresd-mx6dq
		return sBuildModel.startsWith("sabresd"); //sabresd_6dq
	}
	
	public static boolean isHaiXin()
	{
		Log.d(TAG, "isHaiXin(hisense)" + sBuildModel);
		return sBuildModel.startsWith("hs-");
	}
    ...
    public static AudioManager getAudioManager(){
    	if(sAudioManager == null){
    		sAudioManager = (AudioManager)NgnSKDroid.getInstence().getGlobleContext().getSystemService(Context.AUDIO_SERVICE);
    	}
    ...
    public static int getGlEsVersion(){
    	if(sGlEsVersion == 0){
		    sGlEsVersion = ((ActivityManager) NgnSKDroid.getInstence().getGlobleContext().getSystemService(Context.ACTIVITY_SERVICE)).getDeviceConfigurationInfo().reqGlEsVersion;
