...
public abstract class NgnSipSession extends NgnObservableObject implements Comparable<NgnSipSession>{
    ...
    public String getLocalNum(){
        return NgnStringUtils.isNullOrEmpty(mLocalNum) ? "(null)" : mLocalNum;
    }
    public void setLocalNum(String uri){
    	mLocalNum = uri;
    }
	...
	public void setmInfoContent(byte[] mInfoContent) {
  	...
  	public String getHeaderPcscf() {
  		return "sip:pcscf@" + mConfigurationService.getString(
  						NgnConfigurationEntry.NETWORK_PCSCF_HOST,
  						NgnConfigurationEntry.DEFAULT_NETWORK_PCSCF_HOST) + ":" + mConfigurationService.getInt(
  								NgnConfigurationEntry.NETWORK_PCSCF_PORT,
  								NgnConfigurationEntry.DEFAULT_NETWORK_PCSCF_PORT) + ";lr";
  	}
}
